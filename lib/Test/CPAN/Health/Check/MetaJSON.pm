...
Verifies that the distribution ships a well-formed META.json (or META.yml as
a fallback) and that all required fields (name, version, author, license,
abstract, prereqs) are present and non-empty.
