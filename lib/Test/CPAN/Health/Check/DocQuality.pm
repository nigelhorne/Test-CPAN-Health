...
Test::CPAN::Health::Check::DocQuality - Check documentation quality and completeness
...
Uses L<Pod::Checker> to detect POD syntax errors and checks for the
presence of required sections (NAME, SYNOPSIS, DESCRIPTION, AUTHOR,
LICENSE).
